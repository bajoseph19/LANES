    ...
    def get_qu_m(c):
                ...
                for pattern, num in lookups_qu_m:
                    if re.search(pattern,cc.group('b_'+value)) and re.search(pattern,cc.group('a_'+value)):
                        ...
                        for index,pat in enumerate(p):
                            if pat == []:
                                m_b += (fa_b[index][0],fa_b[index][1],fa_b[index][2],fa_b[index][3])
                            elif pat == [1]:
                                m_b += ('1',fa_b[index][0],fa_b[index][2],fa_b[index][3])
                            elif pat == [1,2]:
                                hold_1 = (fa_b[index][0],'single','unit',fa_b[index][3])
                            elif pat == [1,3]:
                                hold_2 = ('1',fa_b[index][0],fa_b[index][2],'item')
                            elif pat == [1,2,3]:
                                m_b += (fa_b[index][0],'single','unit','item')     
                            if [1,2] in p and [1,3] in p:     
                                hold = (hold_1[0][0],hold_2[0][1],hold_2[0][2],hold_1[0][3])
                                m_b += hold
                            elif [1,2] in p:
                                m_b += hold_1
                            elif [1,3] in p:
                        ...
                        for index,pat in enumerate(p):
                            if pat == []:
                                m_a += (fa_a[index][0],fa_a[index][1],fa_a[index][2],fa_a[index][3])
                            elif pat == [1]:
                                m_a += ('1',fa_a[index][0],fa_a[index][2],fa_a[index][3])
                            elif pat == [1,2]:
                                hold_1 = (fa_a[index][0],'single','unit',fa_a[index][3])
                            elif pat == [1,3]:
                                hold_2 = ('1',fa_a[index][0],fa_a[index][2],'item')
                            elif pat == [1,2,3]:
                                m_a += (fa_a[index][0],'single','unit','item')     
                            if [1,2] in p and [1,3] in p:     
                                hold = (hold_1[0][0],hold_2[0][1],hold_2[0][2],hold_1[0][3])
                                m_a += hold
                            elif [1,2] in p:
        ...
        for pattern, num in lookups_qu_m:
            if re.search(pattern, c):
                ...
                for index,pat in enumerate(p):
                    if pat == []:
                        m_m += (fa_m[index][0],fa_m[index][1],fa_m[index][2],fa_m[index][3])
                    elif pat == [1]:
                        m_m += ('1',fa_m[index][0],fa_m[index][2],fa_m[index][3])
                    elif pat == [1,2]:
                        hold_1 = (fa_m[index][0],'single','unit',fa_m[index][3])
                    elif pat == [1,3]:
                        hold_2 = ('1',fa_m[index][0],fa_m[index][2],'item')
                    elif pat == [1,2,3]:
                        m_m += (fa_m[index][0],'single','unit','item')     
                    if [1,2] in p and [1,3] in p:     
                        hold = (hold_1[0][0],hold_2[0][1],hold_2[0][2],hold_1[0][3])
                        m_m += hold
                    elif [1,2] in p:
